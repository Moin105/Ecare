export default {
   ...
   p4:'Refer your friend and earn reward in the form of bonus points',
    ...
    wecare: `Why eCare?`,
    web: `With eCare, you control the course of treatment. We back
    ...
    wep: 'eCare delivers the most secure form of communication, right when you need it.',
    wep2: 'With eCare, you can find The Right top rated experienced Doctors For Your medical issues.',
    wep3: 'We work to offer you the best technology for all kinds of your healthcare needs.',
    gitt:'Get In touch Today!',
    gith:`With eCare, you can Book appointments in 5 easy steps as shown below.
    Moreover, you can choose the method of consultancy according to your needs.`,
    send:"send",
    ...
    science: 'Science',
    research: 'Research',
    cr:'Copyright @ 2021 all rights reserved eCare',
    search: 'Search',
