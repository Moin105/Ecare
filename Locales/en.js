export default {
    ...
    mobile:'Mobile Apps',
    features:'Features',
    bh:'Automated Solution <br></br> for Your Healthcare Needs!',
    cp:'The health, safety and well-being of our members, employees <br></br>  and the communities we serve is our top priority.',
    signin: 'Sign In',
    directory: 'Directory',
